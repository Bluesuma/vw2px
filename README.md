...
[![PyPI version](https://badge.fury.io/py/vw2px.svg)](https://badge.fury.io/py/vw2px)
...
- [Быстрый старт](QUICK_START.md) - Краткое руководство по установке и использованию
- [Публикация на PyPI](DEPLOYMENT.md) - Инструкции по развертыванию
...
**Bluesuma** - [v1tuze@yandex.ru](mailto:v1tuze@yandex.ru)

Проект: [https://github.com/Bluesuma/vw2px](https://github.com/Bluesuma/vw2px)
